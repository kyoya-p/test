(function(root, factory) {
  if (typeof define === 'function' && define.amd) 
    define(['exports', 'kotlin', 'kotlinx-coroutines-core', 'ktor-ktor-utils-jsLegacy', 'ktor-ktor-io-jsLegacy', 'ktor-ktor-http-jsLegacy', 'ktor-ktor-http-cio-jsLegacy', 'ws', 'node-fetch', 'abort-controller', 'node-fetch'], factory);
  else if (typeof exports === 'object') 
    factory(module.exports, require('kotlin'), require('kotlinx-coroutines-core'), require('ktor-ktor-utils-jsLegacy'), require('ktor-ktor-io-jsLegacy'), require('ktor-ktor-http-jsLegacy'), require('ktor-ktor-http-cio-jsLegacy'), require('ws'), require('node-fetch'), require('abort-controller'), require('node-fetch'));
  else {
    ...
    if (typeof NodeWebsocket === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-core-jsLegacy'. Its dependency 'ws' was not found. Please, check whether 'ws' is loaded prior to 'ktor-ktor-client-core-jsLegacy'.");
    }
    if (typeof NodeFetch === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-core-jsLegacy'. Its dependency 'node-fetch' was not found. Please, check whether 'node-fetch' is loaded prior to 'ktor-ktor-client-core-jsLegacy'.");
    }
    if (typeof AbortController === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-core-jsLegacy'. Its dependency 'abort-controller' was not found. Please, check whether 'abort-controller' is loaded prior to 'ktor-ktor-client-core-jsLegacy'.");
    }
    if (typeof nodeFetch === 'undefined') {
      throw new Error("Error loading module 'ktor-ktor-client-core-jsLegacy'. Its dependency 'node-fetch' was not found. Please, check whether 'node-fetch' is loaded prior to 'ktor-ktor-client-core-jsLegacy'.");
    }
    root['ktor-ktor-client-core-jsLegacy'] = factory(typeof this['ktor-ktor-client-core-jsLegacy'] === 'undefined' ? {} : this['ktor-ktor-client-core-jsLegacy'], kotlin, this['kotlinx-coroutines-core'], this['ktor-ktor-utils-jsLegacy'], this['ktor-ktor-io-jsLegacy'], this['ktor-ktor-http-jsLegacy'], this['ktor-ktor-http-cio-jsLegacy'], NodeWebsocket, NodeFetch, AbortController, nodeFetch);
  }
}(this, function(_, Kotlin, $module$kotlinx_coroutines_core, $module$ktor_ktor_utils_jsLegacy, $module$ktor_ktor_io_jsLegacy, $module$ktor_ktor_http_jsLegacy, $module$ktor_ktor_http_cio_jsLegacy, $module$ws, $module$node_fetch, $module$abort_controller, $module$node_fetch_0) {
  'use strict';
  ...
  var cancel_1 = $module$ktor_ktor_io_jsLegacy.io.ktor.utils.io.cancel_3dmw3p$;
  ...
  var Headers_0 = $module$ktor_ktor_http_jsLegacy.io.ktor.http.Headers;
  ...
  var NodeFetch$Headers = $module$node_fetch.Headers;
  ...
  function FormPart(key, value, headers) {
    if (headers === void 0) 
      headers = Headers_0.Companion.Empty;
    this.key = key;
    this.value = value;
    this.headers = headers;
  }
    ...
    switch (this.state_0) {
      case 0:
        ...
        if (util.PlatformUtils.IS_NODE) {
          tmp$ = new $module$ws(this.local$urlString);
        } else {
      ...
      case 3:
        ...
        return new HttpResponseData(HttpStatusCode.Companion.OK, this.local$requestTime, Headers_0.Companion.Empty, HttpProtocolVersion.Companion.HTTP_1_1, session, this.local$callContext);
      case 4:
        throw this.exception_0;
      default:
        this.state_0 = 4;
  ...
  closure$jsHeaders.set(key, value);
  return Unit;
};
  }
    ...
    switch (this.state_0) {
      case 0:
        ...
        if (util.PlatformUtils.IS_BROWSER) {
          ...
          tmp$ = new NodeFetch$Headers();
        }
        this.local$jsHeaders = tmp$;
        ...
        if (Kotlin.isType(content, OutgoingContent$ByteArrayContent)) {
          this.local$tmp$_0 = content.bytes();
          this.state_0 = 6;
          continue;
        } else {
      ...
      case 1:
        throw this.exception_0;
      case 2:
        this.local$tmp$_0 = readBytes(this.result_0);
        this.state_0 = 3;
        continue;
      case 3:
        this.state_0 = 5;
      ...
      case 5:
        ...
        continue;
      case 6:
        var bodyBytes = this.local$tmp$_0 != null ? new Uint8Array(toTypedArray(this.local$tmp$_0)) : null;
        var tmp$_0 = this.local$$receiver.method.value;
        var tmp$_1 = void 0;
        var tmp$_2 = void 0;
        var tmp$_3 = void 0;
        var tmp$_4 = void 0;
        ...
        var o = {};
        o['method'] = tmp$_0;
        o['headers'] = this.local$jsHeaders;
        o['body'] = bodyBytes;
        o['referrer'] = tmp$_1;
  ...
  function get_signal($receiver) {
    var tmp$;
    return Kotlin.isType(tmp$ = $receiver.signal, AbortSignal) ? tmp$ : throwCCE();
  }
  function set_signal($receiver, newValue) {
    $receiver.signal = newValue;
  }
  ...
  function commonFetch$lambda$lambda_1(closure$continuation) {
    return function(it) {
  var $receiver = closure$continuation;
  var exception = new Error_0('Fail to fetch', it);
  ...
  if (util.PlatformUtils.IS_BROWSER) {
    ...
    tmp$ = new $module$abort_controller();
  }
  var controller = tmp$;
  set_signal(closure$init, controller.signal);
  continuation.invokeOnCancellation_f05bi3$(commonFetch$lambda$lambda(controller));
  if (util.PlatformUtils.IS_BROWSER) {
    tmp$_0 = window.fetch(closure$input, closure$init);
  } else {
    tmp$_0 = $module$node_fetch_0(closure$input, closure$init);
  }
  var promise = tmp$_0;
  ...
  closure$responseData.offer_11rb$(asByteArray(new Uint8Array(chunk)));
  ...
  package$compatibility.get_signal_4726du$ = get_signal;
  package$compatibility.set_signal_g8fgly$ = set_signal;
  package$compatibility.commonFetch_70q1td$ = commonFetch;
